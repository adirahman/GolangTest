...
func main() {
	...
	router.DELETE("/company/:id", auth, inDB.DelteCompany)

	//friends
	router.GET("/friends", auth, inDB.GetFriends)
	router.POST("/friend", auth, inDB.CreateFriends)

	//work history
	router.GET("/workhistories/:id", auth, inDB.GetWorkHistory)
	router.POST("/workhostory", auth, inDB.CreateWork)
